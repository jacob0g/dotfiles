...
| Strategy decisions or learnings | `context/{topic}.md` with dated entries (for significant technical decisions, use the `architecture-decision-records` skill's ADR format instead) |
